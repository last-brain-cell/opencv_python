...
def resize(image, factor):
    print(f"Changing Size of Image and number of pixels {factor} times.")
    img_resize = cv2.resize(img, (int(image.shape[1] / factor), int(image.shape[0] / factor)))
...
def shapes():
    ...
    cv2.line(img, (10,10), (200, 200), (255, 0, 0), 3)  # drawing a line
